...
A [weweb.io](https://www.weweb.io/) element that initializes [cuelume](https://github.com/Danilaa1/cuelume) — curated interaction sounds synthesized live via the Web Audio API, with no audio files and no runtime dependencies.
